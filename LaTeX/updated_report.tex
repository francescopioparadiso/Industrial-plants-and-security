...
\noindent
Tutti i calcoli sono disponibili negli allegati "\attachfile[description={01. Plancia A1-B.xlsx}]{attachments/01. Plancia A1-B.xlsx}{\texttt{01. Plancia A1-B.xlsx}}" e "\attachfile[description={02. Plancia A2-D.xlsx}]{attachments/02. Plancia A2-D.xlsx}{\texttt{02. Plancia A2-D.xlsx}}".
\newpage
...
Le altre distinte base sono disponibili nell'allegato "\attachfile[description={07. Distinta base.pdf}]{attachments/07. Distinta base.pdf}{\texttt{07. Distinta base.pdf}}".
\vskip4em
...
\noindent
Gli altri diagrammi ad albero sono disponibili nell'allegato "\attachfile[description={08. Processo produttivo.pdf}]{attachments/08. Processo produttivo.pdf}{\texttt{08. Processo produttivo.pdf}}".
\newpage
...
\noindent
È possibile consultare la matrice WBS-OBS completa nell'allegato "\attachfile[description={03. Matrice WBS-OBS.xlsx}]{attachments/03. Matrice WBS-OBS.xlsx}{\texttt{03. Matrice WBS-OBS.xlsx}}".
\newpage
...
\noindent
Il diagramma di Gantt completo è disponibile nell'allegato "\attachfile[description={05. Gantt.xlsx}]{attachments/05. Gantt.xlsx}{\texttt{05. Gantt.xlsx}}".
\newpage
...
È possibile consultare il layout dell'area interna nell'allegato "\attachfile[description={15. Area interna.pdf}]{attachments/15. Area interna.pdf}{\texttt{15. Area interna.pdf}}".
\vskip4em
...
\vskip1em
È possibile consultare il layout dell'area di ricarica carrelli nell'allegato "\attachfile[description={16. Area ricarica.pdf}]{attachments/16. Area ricarica.pdf}{\texttt{16. Area ricarica.pdf}}" mentre i calcoli sono disponibili nell'allegato "\attachfile[description={04. Excel completo.xlsx}]{attachments/04. Excel completo.xlsx}{\texttt{04. Excel completo.xlsx}}".
\newpage
...
\noindent
È possibile consultare il layout dell'area esterna nell'allegato "\attachfile[description={17. Area parcheggi.pdf}]{attachments/17. Area parcheggi.pdf}{\texttt{17. Area parcheggi.pdf}}".
\newpage
...
È possibile consultare l'ortografia di ubicazione dell'impianto nell'allegato "\attachfile[description={18. Collocazione stabilimento.pdf}]{attachments/18. Collocazione stabilimento.pdf}{\texttt{18. Collocazione stabilimento.pdf}}".
\newpage
...
È possibile consultare il layout della postazione di saldatura nell'allegato "\attachfile[description={11. Studio postazione saldatura.pdf}]{attachments/11. Studio postazione saldatura.pdf}{\texttt{11. Studio postazione saldatura.pdf}}".
\vskip4em
...
È possibile consultare il layout della postazione di assemblaggio nell'allegato "\attachfile[description={12. Studio postazione assemblaggio.pdf}]{attachments/12. Studio postazione assemblaggio.pdf}{\texttt{12. Studio postazione assemblaggio.pdf}}".
\vskip4em
...
Ai fini della standardizzazione del modello di carrello elevatore e poiché la scelta dei magazzini è ricaduta sulla scaffalatura drive-thrugh è stato scelto il carrello per corsie strette BT-STAXIO SERIE S TOYOTA (documentazione dell'elevatore disponibile nell'allegato "\attachfile[description={09. Elevatore BT STAXIO.pdf}]{attachments/09. Elevatore BT STAXIO.pdf}{\texttt{09. Elevatore BT STAXIO.pdf}}").
Questo carrello è l'unico in grado di accedere alle corsie del magazzino materie prime, in quanto è largo solo 80 cm.
\vskip2em

Per le aree di carico e scarico dei camion sono stati scelti i transpallet manuali BT-LIFTER SERIE L TOYOTA (documentazione del transpallet disponibile nell'allegato "\attachfile[description={10. Transpallet BT LIFTER.pdf}]{attachments/10. Transpallet BT LIFTER.pdf}{\texttt{10. Transpallet BT LIFTER.pdf}}").
\newpage
...
\noindent
Tutti i calcoli possono essere consultati nell'allegato "\attachfile[description={04. Excel completo.xlsx}]{attachments/04. Excel completo.xlsx}{\texttt{04. Excel completo.xlsx}}".
\newpage
...
È possibile consultare tutti i calcoli effettuati per il dimensionamento del magazzino buffer nell'allegato "\attachfile[description={04. Excel completo.xlsx}]{attachments/04. Excel completo.xlsx}{\texttt{04. Excel completo.xlsx}}".
\newpage
...
\noindent
Per consultare tutti i calcoli effettuati per il dimensionamento del magazzino prodotti finiti, è possibile fare riferimento all'allegato "\attachfile[description={04. Excel completo.xlsx}]{attachments/04. Excel completo.xlsx}{\texttt{04. Excel completo.xlsx}}".
\newpage
...
\noindent
È possibile consultare l'analisi ABC completa nell'allegato "\attachfile[description={04. Excel completo.xlsx}]{attachments/04. Excel completo.xlsx}{\texttt{04. Excel completo.xlsx}}".
\newpage
...
Tutti i calcoli sono disponibili nell'apposita sezinoe dell'allegato "\attachfile[description={04. Excel completo.xlsx}]{attachments/04. Excel completo.xlsx}{\texttt{04. Excel completo.xlsx}}" mentre il layout dell'area di picking è disponibile nell'allegato "\attachfile[description={14. Area picking.pdf}]{attachments/14. Area picking.pdf}{\texttt{14. Area picking.pdf}}".
...
È possibile consultare il layout dell'area di ricevimento nell'allegato "\attachfile[description={13. Area ricezione.pdf}]{attachments/13. Area ricezione.pdf}{\texttt{13. Area ricezione.pdf}}".
\newpage
...
\noindent
È possibile consultare i calcoli nell'allegato "\attachfile[description={06. Aria compressa assemblaggio.xlsx}]{attachments/06. Aria compressa assemblaggio.xlsx}{\texttt{06. Aria compressa assemblaggio.xlsx}}".
...
\vskip2em
\noindent
È possibile consultare i calcoli nell'allegato "\attachfile[description={04. Excel completo.xlsx}]{attachments/04. Excel completo.xlsx}{\texttt{04. Excel completo.xlsx}}".
\newpage
...
\noindent
Per consultare le VSM complete per tutti i prodotti, è possibile fare riferimento all'allegato "\attachfile[description={04. Excel completo.xlsx}]{attachments/04. Excel completo.xlsx}{\texttt{04. Excel completo.xlsx}}".
\newpage
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|}
        ...
        \hline
        \attachfile[description={01. Plancia A1-B.xlsx}]{attachments/01. Plancia A1-B.xlsx}{\texttt{01. Plancia A1-B.xlsx}} & Excel \\
        \attachfile[description={02. Plancia A2-D.xlsx}]{attachments/02. Plancia A2-D.xlsx}{\texttt{02. Plancia A2-D.xlsx}} & Excel \\
        \attachfile[description={03. Matrice WBS-OBS.xlsx}]{attachments/03. Matrice WBS-OBS.xlsx}{\texttt{03. Matrice WBS-OBS.xlsx}} & Excel \\
        \attachfile[description={04. Excel completo.xlsx}]{attachments/04. Excel completo.xlsx}{\texttt{04. Excel completo.xlsx}} & Excel \\
        \attachfile[description={05. Gantt.xlsx}]{attachments/05. Gantt.xlsx}{\texttt{05. Gantt.xlsx}} & Excel \\
        \attachfile[description={06. Aria compressa assemblaggio.xlsx}]{attachments/06. Aria compressa assemblaggio.xlsx}{\texttt{06. Aria compressa assemblaggio.xlsx}} & Excel \\
        \attachfile[description={07. Distinta base.pdf}]{attachments/07. Distinta base.pdf}{\texttt{07. Distinta base.pdf}} & PDF \\
        \attachfile[description={08. Processo produttivo.pdf}]{attachments/08. Processo produttivo.pdf}{\texttt{08. Processo produttivo.pdf}} & PDF \\
        \attachfile[description={09. Elevatore BT STAXIO.pdf}]{attachments/09. Elevatore BT STAXIO.pdf}{\texttt{09. Elevatore BT STAXIO.pdf}} & PDF \\
        \attachfile[description={10. Transpallet BT LIFTER.pdf}]{attachments/10. Transpallet BT LIFTER.pdf}{\texttt{10. Transpallet BT LIFTER.pdf}} & PDF \\
        \attachfile[description={11. Studio postazione saldatura.pdf}]{attachments/11. Studio postazione saldatura.pdf}{\texttt{11. Studio postazione saldatura.pdf}} & PDF \\
        \attachfile[description={12. Studio postazione assemblaggio.pdf}]{attachments/12. Studio postazione assemblaggio.pdf}{\texttt{12. Studio postazione assemblaggio.pdf}} & PDF \\
        \attachfile[description={13. Area ricezione.pdf}]{attachments/13. Area ricezione.pdf}{\texttt{13. Area ricezione.pdf}} & PDF \\
        \attachfile[description={14. Area picking.pdf}]{attachments/14. Area picking.pdf}{\texttt{14. Area picking.pdf}} & PDF \\
        \attachfile[description={15. Area interna.pdf}]{attachments/15. Area interna.pdf}{\texttt{15. Area interna.pdf}} & PDF \\
        \attachfile[description={16. Area ricarica.pdf}]{attachments/16. Area ricarica.pdf}{\texttt{16. Area ricarica.pdf}} & PDF \\
        \attachfile[description={17. Area parcheggi.pdf}]{attachments/17. Area parcheggi.pdf}{\texttt{17. Area parcheggi.pdf}} & PDF \\
        \attachfile[description={18. Collocazione stabilimento.pdf}]{attachments/18. Collocazione stabilimento.pdf}{\texttt{18. Collocazione stabilimento.pdf}} & PDF \\
        \attachfile[description={19. Spaghetti Chart A1.pdf}]{attachments/19. Spaghetti Chart A1.pdf}{\texttt{19. Spaghetti Chart A1.pdf}} & PDF \\
        \attachfile[description={20. Spaghetti Chart B.pdf}]{attachments/20. Spaghetti Chart B.pdf}{\texttt{20. Spaghetti Chart B.pdf}} & PDF \\
        \attachfile[description={21. Spaghetti Chart A2.pdf}]{attachments/21. Spaghetti Chart A2.pdf}{\texttt{21. Spaghetti Chart A2.pdf}} & PDF \\
        \attachfile[description={22. Spaghetti Chart D.pdf}]{attachments/22. Spaghetti Chart D.pdf}{\texttt{22. Spaghetti Chart D.pdf}} & PDF \\
        \attachfile[description={23. Planimetria interno ed esterno.pdf}]{attachments/23. Planimetria interno ed esterno.pdf}{\texttt{23. Planimetria interno ed esterno.pdf}} & PDF \\
        \attachfile[description={24. Planimetria interna con piani.pdf}]{attachments/24. Planimetria interna con piani.pdf}{\texttt{24. Planimetria interna con piani.pdf}} & PDF \\
        \hline
    \end{tabular}
    }
